...
/**
 * [getDeviceOrientation description]
 * @return {[type]} [description]
 */
...
/**
 * [isSupported 対応ブラウザかどうか判定]
 * @param  {[type]}  browsers [対応ブラウザ名を配列で渡す(ie6、ie7、ie8、ie9、ie10、ie11、chrome、safari、opera、firefox)]
 * @return {Boolean}          [サポートしてるかどうかをtrue/falseで返す]
 */
...
/**
 * [removeSmoothScroll description]
 * @return {[type]} [description]
 */
...
/**
 * [androidVersion Androidのバージョン判断]
 * @return {[type]} [description]
 */
